...
public class Main {
    public static void main(String[] args) {
        ...
        scanner.close();
            ...
            String username = "testUser";      // Thay đổi tên người dùng nếu cần
            String password = "testPassword";   // Nên mã hóa mật khẩu thực tế
            String email = "test@example.com";  // Địa chỉ email
            String role = "USER";               // Vai trò của người dùng
